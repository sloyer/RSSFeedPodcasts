...
// Rate limiting configuration to be very respectful to servers
const RATE_LIMIT = {
  delayBetweenRequests: 3000, // 3 seconds between requests (very conservative)
  batchSize: 10, // Process 10 episodes at a time (smaller batches)
  delayBetweenBatches: 8000, // 8 seconds between batches (very respectful)
  maxRetries: 2 // Fewer retries to avoid hammering
};
